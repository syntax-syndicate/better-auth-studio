...
const IP_RANGES = [
  // North America
  { country: 'United States', countryCode: 'US', city: 'New York', region: 'New York', ranges: [
  ...
  { country: 'Canada', countryCode: 'CA', city: 'Toronto', region: 'Ontario', ranges: [
    { min: '24.0.0.0', max: '24.255.255.255' },
    { min: '70.0.0.0', max: '70.255.255.255' },
  ...
  // Europe
  { country: 'United Kingdom', countryCode: 'GB', city: 'London', region: 'England', ranges: [
  ...
  { country: 'Germany', countryCode: 'DE', city: 'Berlin', region: 'Berlin', ranges: [
    { min: '46.0.0.0', max: '46.255.255.255' },
  ...
  { country: 'France', countryCode: 'FR', city: 'Paris', region: 'Île-de-France', ranges: [
  ...
  // Asia
  { country: 'Japan', countryCode: 'JP', city: 'Tokyo', region: 'Tokyo', ranges: [
  ...
  { country: 'China', countryCode: 'CN', city: 'Beijing', region: 'Beijing', ranges: [
  ...
  { country: 'India', countryCode: 'IN', city: 'Mumbai', region: 'Maharashtra', ranges: [
    { min: '103.0.0.0', max: '103.255.255.255' },
    { min: '117.0.0.0', max: '117.255.255.255' },
    { min: '122.0.0.0', max: '122.255.255.255' },
    { min: '180.0.0.0', max: '180.255.255.255' },
  ...
  // Oceania
  { country: 'Australia', countryCode: 'AU', city: 'Sydney', region: 'New South Wales', ranges: [
    { min: '1.0.0.0', max: '1.255.255.255' },
    { min: '14.0.0.0', max: '14.255.255.255' },
    { min: '27.0.0.0', max: '27.255.255.255' },
    { min: '36.0.0.0', max: '36.255.255.255' },
  ...
  // South America
  { country: 'Brazil', countryCode: 'BR', city: 'São Paulo', region: 'São Paulo', ranges: [
  ...
  // Africa
  { country: 'South Africa', countryCode: 'ZA', city: 'Cape Town', region: 'Western Cape', ranges: [
  ...
  // Russia
  { country: 'Russia', countryCode: 'RU', city: 'Moscow', region: 'Moscow', ranges: [
    { min: '5.0.0.0', max: '5.255.255.255' },
    { min: '31.0.0.0', max: '31.255.255.255' },
    { min: '37.0.0.0', max: '37.255.255.255' },
    { min: '46.0.0.0', max: '46.255.255.255' },
...
function testDatabase() {
  ...
  testIPs.forEach(ip => {
    ...
    console.log(`📍 ${ip} → ${location.city}, ${location.country} ${location.countryCode ? `(${location.countryCode})` : ''}`);
  });
}
