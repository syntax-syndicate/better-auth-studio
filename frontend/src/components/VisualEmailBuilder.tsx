...
export default function VisualEmailBuilder({ html, onChange }: VisualEmailBuilderProps) {
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      {/* Left: Canvas */}
      <div className="flex-1 flex flex-col overflow-hidden bg-white border-r border-dashed border-white/20" style={{ minWidth: '500px' }}>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-8 bg-gray-50" style={{ overscrollBehavior: 'contain' }}>
      ...
      {selectedBlock && (
        <div className="w-96 border-l border-dashed border-white/20 bg-black/40 flex flex-col flex-shrink-0 overflow-hidden" style={{ minWidth: '384px', maxWidth: '384px' }}>
          ...
          <div className="p-4 space-y-4 overflow-y-auto overflow-x-hidden flex-1" style={{ overscrollBehavior: 'contain' }}>
            {/* Content */}
